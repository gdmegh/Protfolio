...
export const allProjects = [
    {
      ...
      image: '/images/projects/alpha-cover.png',
      tags: ['UX Design', 'Mobile App', 'Case Study'],
      hint: 'tech product',
      mockupImages: [
        { src: '/images/projects/alpha-mockup-1.png', hint: 'mobile app screen' },
        { src: '/images/projects/alpha-mockup-2.png', hint: 'app analytics dashboard' },
        { src: '/images/projects/alpha-mockup-3.png', hint: 'user profile ui' },
      ],
      metrics: [
    ...
    },
    {
      ...
      image: '/images/projects/beta-cover.png',
      tags: ['UX Research', 'Web App', 'SaaS'],
      hint: 'dashboard ui',
      mockupImages: [
        { src: '/images/projects/beta-mockup-1.png', hint: 'saas dashboard' },
        { src: '/images/projects/beta-mockup-2.png', hint: 'onboarding flow' },
        { src: '/images/projects/beta-mockup-3.png', hint: 'user analytics chart' },
      ],
      metrics: [
    ...
    },
    {
      ...
      image: '/images/projects/gamma-cover.png',
      tags: ['Design System', 'Accessibility', 'E-commerce'],
      hint: 'design system',
      mockupImages: [
        { src: '/images/projects/gamma-mockup-1.png', hint: 'design system components' },
        { src: '/images/projects/gamma-mockup-2.png', hint: 'color palette styleguide' },
        { src: '/images/projects/gamma-mockup-3.png', hint: 'typography examples' },
      ],
      metrics: [
    ...
    },
    {
      ...
      image: '/images/projects/delta-cover.png',
      tags: ['Prototyping', 'UI Design', 'Social Media'],
      hint: 'mobile ui',
      mockupImages: [
        { src: '/images/projects/delta-mockup-1.png', hint: 'social media app' },
        { src: '/images/projects/delta-mockup-2.png', hint: 'user feed' },
        { src: '/images/projects/delta-mockup-3.png', hint: 'collaboration feature' },
      ],
      metrics: [
    ...
    },
    {
      ...
      image: '/images/projects/epsilon-cover.png',
      tags: ['Gamification', 'UI Design', 'Non-profit'],
      hint: 'gamification ui',
      mockupImages: [
        { src: '/images/projects/epsilon-mockup-1.png', hint: 'learning app interface' },
        { src: '/images/projects/epsilon-mockup-2.png', hint: 'gamified badges' },
        { src: '/images/projects/epsilon-mockup-3.png', hint: 'leaderboard screen' },
      ],
      metrics: [
    ...
    },
    {
      ...
      image: '/images/projects/zeta-cover.png',
      tags: ['Data Viz', 'Fintech', 'Dashboard'],
      hint: 'financial dashboard',
      mockupImages: [
        { src: '/images/projects/zeta-mockup-1.png', hint: 'financial data chart' },
        { src: '/images/projects/zeta-mockup-2.png', hint: 'investment dashboard' },
        { src: '/images/projects/zeta-mockup-3.png', hint: 'stock market graph' },
      ],
      metrics: [
